...
/**
 * ! \brief Parametros usados para fazer requisições HTTP
 */
 ...
 typedef struct http_client_request{
    ...
    /**
     * ! 
     * Nome do host ex: www.google.com
     */
    ...
    /**
     * !
     * A url que será feita as requisições ex:
     */
    const char *url;
 ...
 * @see async_context
 */
int http_client_request_async(struct async_context *context, http_client_request_t *req);
 ...
 */
int http_client_request_sync(struct async_context *context, http_client_request_t *req);
